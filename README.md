<div align="center">
    <img src="images/banner.jpg" style="width:500;"/></br></br>
    <h1><code>🤖💻 {Code} is The New CLI >_ ✨</code></h1>
    <img src="https://img.shields.io/badge/Cisco_DevNet-1BA0D7?style=flat-square&logo=cisco&logoColor=white" alt="Cisco DevNet">
    <img src="https://img.shields.io/badge/%F0%9F%87%B0%F0%9F%87%AA_Nairobi_DevOps_Community-006BB6?style=flat-square" alt="Nairobi DevOps Community">
    <img src="https://img.shields.io/badge/Python-3.10+-3776AB?style=flat-square&logo=python&logoColor=white" alt="Python">
    <img src="https://img.shields.io/badge/Ansible-EE0000?style=flat-square&logo=ansible&logoColor=white" alt="Ansible">
    <img src="https://img.shields.io/badge/Terraform-7B42BC?style=flat-square&logo=terraform&logoColor=white" alt="Terraform">
    <img src="https://img.shields.io/badge/Telemetry-425CC7?style=flat-square&logo=opentelemetry&logoColor=white" alt="Telemetry">
...
| Date | Session | Topics | Video |
|:-----|:--------|:-------|:-------|
| **April 27** | [🔗 Foundations & Data Handling](./session-01-foundations/) | Versioning with Git, Python for network engineers, data formats, parsing and templating| [🎬 Watch here!](https://www.youtube.com/watch?v=yZlw-VB9U3k) |
| **April 30** | [🔗 Network interaction and IaC principles](./session-02-foundations/) | Usage of the pyATS library for network read/write, CLI parsing, device snapshots and Ansible 101 | [🎬 Watch here!](https://www.youtube.com/watch?v=KFFj6zE9s_E) |
| **May 4** | [🔗 Infrastructure & Automation Part 1](./session-03-models/) | Introduction to OpenTofu, model-driven programmability concepts, NETCONF protocol | [🎬 Watch here!](https://www.youtube.com/watch?v=3mJTiCkngEE) |
| **May 7** | [🔗 Infrastructure & Automation Part 2](./session-04-telemetry/) | API usage principles, RESTCONF protocol, streaming telemetry and observability | [🎬 Watch here!](https://www.youtube.com/watch?v=lKlhL_tq2kE) |
