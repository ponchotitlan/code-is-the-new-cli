...
| # | Skill |
|:---:|:---|
| 1 | 🔌 Connect to sandbox devices and collect operational state with pyATS |
| 2 | 🔍 Parse and validate device outputs using structured data workflows |
| 3 | 📸 Capture before/after snapshots and generate auditable diffs |
| 4 | ▶️ Build and run Ansible playbooks for safe read and write operations on IOS XR |
| 5 | ♻️ Prove idempotence by rerunning automations and comparing outcomes |

---

## 🗺️ Today's mission

> Move from one-off CLI checks to repeatable, evidence-driven automation workflows.
